/* Browser UMD build */(function(g,f){if(typeof define=="function"&&define.amd){define(f)}else if(typeof exports=="object" && typeof module<"u"){module.exports=f()}else{var m=f();for(var i in m) g[i]=m[i]}}(typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : this,function(){var exports={};var __exports=exports;var module={exports};
"use strict";
...
var import_eventemitter3, _emitter, EventEmitter;
var init_events = __esm({
  "src/domain/events/index.ts"() {
    "use strict";
    import_eventemitter3 = require("eventemitter3");
    EventEmitter = class {
      constructor() {
        __privateAdd(this, _emitter, new import_eventemitter3.EventEmitter());
      }
      /**
...
var import_debug, createLogger, enableDebug, isEnabled;
var init_logger = __esm({
  "src/domain/logger/index.ts"() {
    "use strict";
    import_debug = __toESM(require("debug"));
    createLogger = (namespace = "metamask-sdk", color = "214") => {
      const logger4 = (0, import_debug.default)(namespace);
      logger4.color = color;
      return logger4;
    };
...
__export(index_browser_exports, {
  ...
  EIP155_CAPABILITIES_SESSION_PROPERTY: () => EIP155_CAPABILITIES_SESSION_PROPERTY,
...
var BaseModalFactory = class {
  ...
  onCloseModal(shouldTerminate = true) {
    return __async(this, null, function* () {
      return this.unload(
        shouldTerminate ? import_rpc_errors3.providerErrors.userRejectedRequest() : void 0
      );
    });
  }
