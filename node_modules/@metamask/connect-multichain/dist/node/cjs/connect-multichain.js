...
var init_logger = __esm({
  "src/domain/logger/index.ts"() {
    ...
    createLogger = (namespace = "metamask-sdk", color = "214") => {
      const logger5 = (0, import_debug.default)(namespace);
      logger5.color = color;
      return logger5;
    };
    ...
    MWPTransport = class {
      ...
      disconnect() {
        return __async(this, arguments, function* (scopes = []) {
          ...
          const cachedSessionScopes = (_a2 = cachedSession == null ? void 0 : cachedSession.sessionScopes) != null ? _a2 : {};
...
tryLocalCapabilities_fn = function(options) {
  return __async(this, null, function* () {
    ...
    const capabilitiesByAddress = (_a2 = sessionResult == null ? void 0 : sessionResult.sessionProperties) == null ? void 0 : _a2[EIP155_CAPABILITIES_SESSION_PROPERTY];
