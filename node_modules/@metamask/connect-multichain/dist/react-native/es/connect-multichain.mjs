...
var createMultichainClient = (options) => __async(null, null, function* () {
  ...
  if (options.storage) {
    ...
    let StoreAdapterRN2;
    try {
      ({ StoreAdapterRN: StoreAdapterRN2 } = yield Promise.resolve().then(() => (init_rn2(), rn_exports2)));
    } catch (error) {
      throw new Error(
        `@metamask/connect-multichain: @react-native-async-storage/async-storage is required for React Native. Install it with: npm install @react-native-async-storage/async-storage
